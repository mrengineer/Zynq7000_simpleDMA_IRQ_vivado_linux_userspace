...
module design_1_my_0_0(sys_clk, sys_rst_n, s_axis_aclk, s_axis_tvalid, 
  ...
  m_axis_tready, m_axis_tdata, m_axis_tkeep, m_axis_tlast, d_last, d_cnt, d_valid)
/* synthesis syn_black_box black_box_pad_pin="sys_clk,sys_rst_n,s_axis_aclk,s_axis_tvalid,s_axis_tready,s_axis_tdata[31:0],s_axis_tkeep[3:0],s_axis_tlast,m_axis_aclk,m_axis_tvalid,m_axis_tready,m_axis_tdata[31:0],m_axis_tkeep[3:0],m_axis_tlast,d_last,d_cnt[3:0],d_valid" */;
  input sys_clk;
  input sys_rst_n;
  input s_axis_aclk;
  input s_axis_tvalid;
